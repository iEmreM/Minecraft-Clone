...
- **Block interaction:** Raycasted placement and removal with an 8-block reach, across **677 block types** — stone, deepslate and ore variants, ten wood sets in log, bark and stripped form, building blocks, decoration, the nether and copper families, corals, the full wool, concrete, concrete powder and terracotta palettes, glass, and the blocks that are not cubes.
- **See-through blocks:** glass, all sixteen stained glass colours, tinted glass, ice and the copper grates, drawn by a second blended pass that leaves the opaque terrain pass untouched.
- **Blocks that are not cubes:** torches on the floor and on the wall, doors, ladders, vines, carpets, pressure plates, snow layers, cacti and cobwebs; lanterns, chains, end rods, lightning rods, cake, anvils, composters, lecterns, stonecutters, enchanting tables; a flower pot with thirty different plants in it; coral fans, sea pickles, spore blossoms, amethyst clusters, dripstone, petals and leaf litter; plus the whole ground cover — grass, ferns, flowers, saplings, mushrooms and crops. Each one is the real game's own model, box for box, rotation for rotation and texture rect for texture rect, so a torch is a torch from every angle and a wheat field reads as rows. Plants are nudged off the grid from a hash of where they stand, so a meadow is a meadow rather than a lattice.
- **Blocks that know which way they were placed:** a door faces the player who hung it, a ladder or a wall torch hugs the wall it was clicked onto, and a furnace, smoker, blast furnace, dispenser, dropper, loom, crafting table, beehive or jack o'lantern turns its front to face you. Doors place and break as two blocks, because half a door is worse than none.
- **Ground cover on the world itself:** every biome carries its own mix at the real game's own densities — a plains scattered with dandelions, poppies and four kinds of tulip, a meadow thick with alliums and cornflowers, ferns and berry bushes in the taiga, mushrooms under a dark oak roof, cacti and dead bushes in the desert, sugar cane at the water's edge, seagrass on the sea floor, coral fans and sea pickles over a warm-ocean reef, and wheat, carrots or potatoes growing on moist farmland in the village farms — which are laid out along dirt-path streets under lantern-topped lamp posts.
