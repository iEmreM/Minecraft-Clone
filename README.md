...
- **Block interaction:** Raycasted placement and removal with an 8-block reach, across **508 block types** — stone, deepslate and ore variants, ten wood sets in log, bark and stripped form, building blocks, decoration, the nether and copper families, corals, the full wool, concrete, concrete powder and terracotta palettes, glass, and the blocks that are not cubes.
...
- **Blocks that are not cubes:** torches, doors, ladders, carpets, pressure plates, snow layers, cacti and cobwebs, plus the whole ground cover — grass, ferns, flowers, saplings, mushrooms and crops. Each one is the real game's own model, box for box and texture rect for texture rect, so a torch is a torch from every angle and a wheat field reads as rows. Doors know which way they face and place and break as two blocks; plants are nudged off the grid from a hash of where they stand, so a meadow is a meadow rather than a lattice.
- **Ground cover on the world itself:** every biome carries its own mix at the real game's own densities — a plains scattered with dandelions, poppies and four kinds of tulip, a meadow thick with alliums and cornflowers, ferns and berry bushes in the taiga, mushrooms under a dark oak roof, cacti and dead bushes in the desert, sugar cane at the water's edge, seagrass on the sea floor, and wheat, carrots or potatoes growing in the village farms.
